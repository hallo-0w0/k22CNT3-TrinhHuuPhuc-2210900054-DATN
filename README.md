...
Sau khi triển khai xong, sử dụng tài khoản sau để đăng nhập vào hệ thống quản trị:
...
**⚠️ LƯU Ý BẢO MẬT:**
- Tài khoản admin được tạo tự động bằng script `scripts/seed_admin.py`
- **PHẢI đổi mật khẩu ngay sau lần đăng nhập đầu tiên**
- Không chia sẻ thông tin đăng nhập này với người không có thẩm quyền
- Trong môi trường production, nên thay đổi mật khẩu mạnh hơn
